...
## 2. 为什么需要 Agent Loop / Agent Graph
...
## 3. Agent Loop 与 Agent Graph 的关系和区别

### 3.1 Agent Loop 关注循环行为
...
计划 → 执行 → 检查偏差 → 必要时重规划
```
### 4.10 Planner–Executor–Validator Loop
...
- 多次运行稳定性测试；
- 成本和延迟测试。
## 19. Agent Loop / Graph 与其他工程思想的关系

### 19.1 与 Prompt Engineering 的关系
...
Prompt 是节点内部实现的一部分。
### 19.2 与 Context Engineering 的关系
...
### 19.3 与 Harness Engineering 的关系
